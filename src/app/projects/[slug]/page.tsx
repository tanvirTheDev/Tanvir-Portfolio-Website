...
const projects: {
  ...
  "jaf-washing-plant-corporate-site": {
    id: 3,
    title: "JAF Washing Plant Ltd. Corporate Website",
    slug: "jaf-washing-plant-corporate-site",
    description:
      "A modern, professional, and fully responsive corporate website built for JAF Washing Plant Ltd., featuring smooth animations and a meeting booking system.",
    longDescription:
      "This is a complete corporate website developed for JAF Washing Plant Ltd., a leading industrial washing and garments company in Bangladesh. The goal was to build a fast, visually appealing, and operationally useful website that reflects the company’s services, credibility, and brand identity. The website includes dynamic sections, an animated hero area, service listings, an about section, and a working 'Book a Meeting' feature using EmailJS. The website was built with Next.js, Tailwind CSS, and Framer Motion to ensure optimal performance, smooth animations, and a clean UI across all devices.",
    image: "/jaf-washing/jaf_washing_featured_image.png",
    gallery: [
      "/jaf-washing/about_us.png",
      "/jaf-washing/faculties.png",
      "/jaf-washing/clients.png",
      "/jaf-washing/contact_us.png",
    ],
    technologies: ["Next.js", "Tailwind CSS", "Framer Motion", "EmailJS"],
    category: "Client Project",
    duration: "7 Days",
    client: "JAF Washing Plant Ltd.",
    year: "2024",
    liveUrl: "https://jaf-washing-plant-ltd.vercel.app",
    githubUrl: "https://github.com/tanvirTheDev/jaf-washing-plant-ltd",

    features: [
      "Fully responsive corporate design optimized for all devices",
      "Animated UI interactions using Framer Motion",
      "Dynamic sections: Hero, Services, About, Contact",
      "Functional 'Book a Meeting' form integrated with EmailJS",
      "Clean and modern branding approach",
      "SEO optimized with meta tags and structured content",
      "Fast loading performance with Next.js optimization",
    ],

    challenges: [
      "Creating a clean and premium corporate look that matches the brand identity",
      "Implementing smooth animation transitions without performance issues",
      "Configuring EmailJS securely for form submission",
      "Ensuring pixel-perfect responsiveness across all screen sizes",
    ],

    learnings: [
      "Best practices for building production-ready static corporate websites",
      "Advanced animation techniques using Framer Motion",
      "Improving UX for business websites with simplicity and clarity",
      "Integrating third-party form services like EmailJS in Next.js applications",
    ],
  },
};

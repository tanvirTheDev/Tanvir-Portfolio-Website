...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn("h-auto rounded-md p-1 text-primary", className)}
    {...props}
  />
));
